...
const CANONICAL_REPO = 'https://github.com/ChillandBuild/ApplyDeck.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/ChillandBuild/ApplyDeck/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/ChillandBuild/ApplyDeck/releases/latest';
