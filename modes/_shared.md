...
<!-- ============================================================
     ...
     that improve with each ApplyDeck release.
     ============================================================ -->
...
A mode may tell you to run work in a background subagent (e.g. `scan`, or parallel `pipeline` URLs) to spare the main agent's context. Any subagent you spawn for ApplyDeck is a **single-pass worker**:
