...
export type CostClass = "free" | "free-network" | "spend" | "spend-apify" | "free-gemini";
...
export const COST_META: Record<CostClass, { label: string; tip: string }> = {
  ...
  "spend-apify": {
    label: "Uses credits",
    tip: "Runs a real Apify actor (LinkedIn, Glassdoor, Naukri, ...) — spends your own Apify credits, not AI tokens, and only when you pick sources and confirm.",
  },
  "free-gemini": {
    label: "Free · Gemini",
