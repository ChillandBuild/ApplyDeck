import { LayoutDashboard, Compass, Bot, Search, ListChecks, CalendarClock, Radar, BarChart3, FileText, Settings } from "lucide-react";
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/pilot", label: "Pilot", icon: Bot, chip: "Auto" },
