...
An **experimental, opt-in web UI** for ApplyDeck. It is a local-first *view* over
...
Open http://localhost:3000. The app reads the ApplyDeck checkout it lives in
...
a different ApplyDeck directory (useful for testing against sample data).
